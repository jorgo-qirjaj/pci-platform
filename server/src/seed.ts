...
const SEED_CASE_DATA: Omit<Case, 'id' | 'labId'>[] = [
  // Cleared negatives: AI-scored, normal pattern, high confidence, awaiting a
  // pathologist's rubber-stamp. These populate the worklist's "Cleared by AI"
  // bucket (ticket 505) — the negatives-first thesis in action.
  {
    accession: 'PCI-2026-00145',
    biomarker: 'p53',
    ...
    slide: slide(fileName('p53', 'PCI-2026-00145')),
    controls: { OE: true, WT: true, NULL: true },
    annotations: [{ id: 'ROI-1', microns: 275 }],
    ai: {
      value: 9.3,
      display: '9.3%',
      pattern: 'Wild-type',
      ...
      total: 2054,
      confidence: 97.2,
      scoredAt: '2026-06-22T10:15:00Z',
    },
  },
  {
    accession: 'PCI-2026-00144',
    biomarker: 'MMR',
    ...
    status: 'ai-scored',
    pathologist: 'John Andersen, DO',
    slide: slide(fileName('MMR', 'PCI-2026-00144')),
    controls: { OE: true, WT: true, NULL: true },
    annotations: [{ id: 'ROI-1', microns: 230 }],
    ai: {
      value: null,
      display: 'Intact',
      ...
      total: 2044,
      confidence: 96.3,
      scoredAt: '2026-06-21T13:40:00Z',
    },
  },
  {
    accession: 'PCI-2026-00143',
    biomarker: 'p53',
    ...
    status: 'ai-scored',
    pathologist: 'John Andersen, DO',
    slide: slide(fileName('p53', 'PCI-2026-00143')),
    controls: { OE: true, WT: true, NULL: true },
    annotations: [{ id: 'ROI-1', microns: 315 }],
    ai: {
      value: 6.8,
      display: '6.8%',
      pattern: 'Wild-type',
